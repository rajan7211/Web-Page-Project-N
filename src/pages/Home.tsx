      ...
      <header className="py-20 px-6 bg-slate-50 border-b">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="mt-6 text-lg text-slate-500 max-w-2xl mx-auto leading-relaxed">
            The all-in-one workspace for teams. Manage users, track analytics,
            and handle orders with a polished, modern interface.
          </p>
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            ...
            >
              {isAuthenticated ? "My Account" : "Get Started Free"}{" "}
              <FiArrowRight />
            </Link>
            {!isAuthenticated && (
              <Link
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-4 text-slate-500 text-lg">
              Launch workflows with seamless access control and beautiful
              dashboards.
            </p>
...
function Feature({
  ...
  return (
    <div className="p-6">
      <div className="text-3xl text-blue-600 flex justify-center mb-4">
        {icon}
      </div>
